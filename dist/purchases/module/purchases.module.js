...
const purchases_provider_1 = require("../provider/purchases.provider");
const purchases_service_1 = require("../service/purchases.service");
const purchases_controller_1 = require("../controller/purchases.controller");
...
exports.PurchasesModule = PurchasesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [...purchases_provider_1.PurchasesProvider, purchases_service_1.PurchasesService],
    })
], PurchasesModule);
